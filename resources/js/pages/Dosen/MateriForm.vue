...
const submit = () => {
    if (props.materi) {
        form.transform((data) => ({ ...data, _method: 'PUT' })).post(
            route('dosen.kelas-kuliah.materi.update', [props.kelasKuliah.id, props.materi.id]),
            { forceFormData: true },
        );
    } else {
        form.post(route('dosen.kelas-kuliah.materi.store', props.kelasKuliah.id), { forceFormData: true });
    }
};
