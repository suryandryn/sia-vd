...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pekerjaan = ['PNS', 'Karyawan Swasta', 'Wiraswasta', 'Petani', 'Guru', 'Dokter', 'TNI/Polri', 'Tidak Bekerja'];
